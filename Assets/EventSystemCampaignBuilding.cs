...
public class EventSystemCampaignBuilding : MonoBehaviour {
	...
	public void updateStates() {
		...
		if (Application.systemLanguage == SystemLanguage.German || true){
			text.text =  LocalizationSupport.GetString("BuildingTitle");//"Warum ist der Punkt nicht erreichbar?";

			text = m_TextFunction.GetComponent<UnityEngine.UI.Text>();
			text.text =  LocalizationSupport.GetString("BuildingFunction");//"Grund:";

			text = m_TextNumberLevels.GetComponent<UnityEngine.UI.Text>();
			text.text =  LocalizationSupport.GetString("BuildingNumberLevels");//"Grund:";
			...
			text.text =  LocalizationSupport.GetString("BuildingNature");//"Grund:";
	...
	public void OnQuestion1Click() {
		string[] options2 = { "OK" };
		messageBox.Show ("", LocalizationSupport.GetString("BuildingQuestion1"), options2);	
	}
	public void OnQuestion2Click() {
		string[] options2 = { "OK" };
		messageBox.Show ("", LocalizationSupport.GetString("BuildingQuestion2"), options2);	
	}
	public void OnQuestion3Click() {
		string[] options2 = { "OK" };
		messageBox.Show ("", LocalizationSupport.GetString("BuildingQuestion3"), options2);	
	}
	...
	public void CampaignFinished() {
		...
		PlayerPrefs.SetInt ("Quest_" + m_NrQuestsDone + "_" + "CampaignType", 0);

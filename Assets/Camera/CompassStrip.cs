...
public class CompassStrip : MonoBehaviour , IPhotoTask
{
    ...
    public GameObject m_ButtonEnableCompass;
    public GameObject m_ButtonDisableCompass;
    public bool m_bCompassEnabled = true;
    public GameObject m_ButtonTakePictureWithoutCompass;
    ...
    void Start ()
    {
        ...
        m_ButtonEnableCompass.SetActive(false);
        m_ButtonDisableCompass.SetActive(true);
    ...
    public void UpdateTask ()
    {
        ...
        m_ButtonTakePictureWithoutCompass.SetActive(false);
        if (m_bTakingPointPhoto)
        {
            m_CompassStrip.SetActive(false);
            m_ButtonTakePicture.SetActive(true);
        }
        else if (!m_bCompassEnabled)
        {
            m_CompassStrip.SetActive(false);
            m_ButtonTakePicture.SetActive(false);
            m_ButtonTakePictureWithoutCompass.SetActive(true);
        }
        else
        {
        ...
        {
            if (!Panels[0].IsFinished())
            {
                StatusText.text = "Take a photo towards north";
            }
            else if (!Panels[1].IsFinished())
            {
                StatusText.text = "Take a photo towards east";
            }
            else if (!Panels[2].IsFinished())
            {
                StatusText.text = "Take a photo towards south";
            }
            else if (!Panels[3].IsFinished())
            {
                StatusText.text = "Take a photo towards west";
            }
    ...
    public void TakePhotoWithoutCompass()
    {
        if (!Panels[0].IsFinished())
        {
            TakePicture(0);
    ...
    public void ToggleCompass()
    {
        ...
        {
            m_ButtonEnableCompass.SetActive(true);
            m_ButtonDisableCompass.SetActive(false);
        }
    }
}
